...
import { Heart, ShoppingCart, TrendingUp, Clock, Target, FileText, Search, Star } from "lucide-react";
...
const MarketplaceDashboard = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'content_received':
        return <Badge variant="outline">Content Received</Badge>;
      case 'published':
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center py-12">
            <div className="glass-card p-8 text-center">
              ...
              <p className="text-muted-foreground">Loading your Moody Media marketplace...</p>
            </div>
          </div>
        </main>
      </div>;
  ...
  return <>
      <SEOHead title="Marketplace Dashboard - Moody Media" description="Your premium SEO marketplace dashboard. Track orders, manage campaigns, and discover quality publishers." url="/dashboard/marketplace" />
      
      <div className="min-h-screen bg-background">
        <main className="container mx-auto px-4 py-8">
          <div className="mb-8">
            <div className="glass-card p-8 bg-primary text-primary-foreground">
              <h1 className="text-4xl font-heading font-bold mb-3">Moody Media Marketplace</h1>
              <p className="text-primary-foreground/90 text-lg">
                Your premium SEO marketplace dashboard - discover, order, and track your link building campaigns
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
              ...
              <Card className="glass-card-clean">
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Progress value={stats.orders.total > 0 ? stats.orders.completed / stats.orders.total * 100 : 0} className="h-3" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <Card className="glass-card-clean">
                ...
                <CardContent>
                  {recentOrders.length === 0 ? <div className="text-center py-12">
                      ...
                      {recentOrders.map(order => <div key={order.id} className="glass-card p-4 hover:shadow-medium transition-all duration-300">
              ...
              <Card className="glass-card-clean">
                ...
                <CardContent>
                  {favoritedMedia.length === 0 ? <div className="text-center py-12">
                      <div className="glass-card p-8 inline-block">
                      ...
                      {favoritedMedia.map(item => <div key={item.id} className="glass-card p-4 hover:shadow-medium transition-all duration-300">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">

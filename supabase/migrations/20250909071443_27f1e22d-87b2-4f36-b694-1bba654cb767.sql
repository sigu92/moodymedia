-- Insert seed data for media outlets and metrics
...
('badlands.nu', 'Swedish', 'SE', '{"Gaming", "Entertainment"}', 'Gaming', 155, 'EUR', 'No gambling content. Max 1 outbound link per 500 words. Swedish language required.', 3, '11111111-1111-1111-1111-111111111111'),
('dittandralag.se', 'Swedish', 'SE', '{"Sports", "Football"}', 'Sports', 200, 'EUR', 'Sports-related content only. No competitor mentions. Min 800 words.', 5, '11111111-1111-1111-1111-111111111112'),
('roda-dagar.se', 'Swedish', 'SE', '{"Lifestyle", "Food", "Travel"}', 'Lifestyle', 245, 'EUR', 'High-quality lifestyle content. Professional images required. Min 1000 words.', 7, '11111111-1111-1111-1111-111111111113'),
('mediahyllan.se', 'Swedish', 'SE', '{"Technology", "Media", "Digital"}', 'Technology', 175, 'EUR', 'Tech and media content focus. No adult content. Include relevant statistics.', 4, '11111111-1111-1111-1111-111111111114'),
('bengansbonus.se', 'Swedish', 'SE', '{"Business", "Finance", "Investment"}', 'Business', 245, 'EUR', 'Financial and business content. Must comply with Swedish financial regulations.', 5, '11111111-1111-1111-1111-111111111115'),
('followusaik.se', 'Swedish', 'SE', '{"Sports", "Football", "Soccer"}', 'Sports', 245, 'EUR', 'Football-focused content. Team-neutral stance required. Include match statistics.', 3, '11111111-1111-1111-1111-111111111116'),
('svenskhandelstidning.se', 'Swedish', 'SE', '{"Business", "Trade", "Commerce"}', 'Business', 320, 'EUR', 'B2B content focus. Industry expertise required. Min 1200 words.', 7, '11111111-1111-1111-1111-111111111117'),
('teknikfokus.se', 'Swedish', 'SE', '{"Technology", "Innovation", "Startups"}', 'Technology', 280, 'EUR', 'Cutting-edge tech content. Include technical details and sources.', 6, '11111111-1111-1111-1111-111111111118'),
('naturguiden.se', 'Swedish', 'SE', '{"Nature", "Environment", "Outdoor"}', 'Lifestyle', 190, 'EUR', 'Nature and outdoor content. Environmental focus preferred. Include location details.', 4, '11111111-1111-1111-1111-111111111119'),
('halsokost.se', 'Swedish', 'SE', '{"Health", "Nutrition", "Wellness"}', 'Health', 225, 'EUR', 'Evidence-based health content. Medical claims must be sourced. No supplements promotion.', 5, '11111111-1111-1111-1111-111111111120');

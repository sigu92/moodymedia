-- Temporarily remove foreign key constraint to insert seed data
ALTER TABLE public.media_outlets DROP CONSTRAINT IF EXISTS media_outlets_publisher_id_fkey;
